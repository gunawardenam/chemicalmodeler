...
2) create and activate your conda environment
    ...
    'conda activate chemicalmodeler'
3) run the jupyter notebook entitler 'modeler.ipynb'. Further instructions for the execution can be seen in the section below.
